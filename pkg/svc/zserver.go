...
//
// TODO: Extend the Acme service by defining new RPCs and
...
//
// TODO: Create an implementation of the Acme server
...
// implementation of Acme server interface service, but only
...
// Default implementation of the Acme server interface
...
func NewBasicServer(database *gorm.DB) (pb.AcmeServer, error) {
